...
public sealed partial class ElinModifierPlugin
{
    ...
    private string ExecuteAiToolCall(string name, string arguments, bool cacheAiPluginFeature, bool allowDangerousQueue)
    {
        ...
        switch (name)
        {
            ...
            case "query_item": result = AiToolQueryItem(arguments); break;
            case "query_obtain": result = AiToolQueryObtain(arguments); break;
            case "query_uses": result = AiToolQueryUses(arguments); break;
            case "query_recipe_tree": result = AiToolQueryRecipeTree(arguments); break;
            case "query_npc": result = AiToolQueryNpc(arguments); break;
            case "query_element": result = AiToolQueryElement(arguments); break;
            case "query_material": result = AiToolQueryMaterial(arguments); break;
            case "query_player_state": result = AiToolQueryPlayerState(arguments); break;
            case "world_map_overview": result = AiToolWorldMapOverview(arguments); break;
            case "world_map_zones": result = AiToolWorldMapZones(arguments); break;
            case "world_map_search": result = AiToolWorldMapSearch(arguments); break;
            case "world_map_route": result = AiToolWorldMapRoute(arguments); break;
