...
public sealed partial class ElinModifierPlugin
{
    ...
    private const int AiContextCompressionMinCompressibleWeight = 2000;
    private const int AiContextCompressionMinGrowthWeight = 4000;
    private const int AiContextPreservedUserWeightDivisor = 2;
    private const int AiHistoryToolResultMaxChars = 6000;
    private const int AiHistoryPartialResponseMaxChars = 4000;
    private const int AiToolLoopResultMaxChars = 60000;
    ...
    private const int AiToolLoopMaxRounds = 64;
